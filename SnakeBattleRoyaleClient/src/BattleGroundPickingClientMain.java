...
public class BattleGroundPickingClientMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BattleGroundPickingClientMain frame = new BattleGroundPickingClientMain();
	 ...
	 * Create the frame.
	 */
	public BattleGroundPickingClientMain() {
	...
	class Myaction implements ActionListener // 내부클래스로 액션 이벤트 처리 클래스
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			BattleGroundPickingClientView view = new BattleGroundPickingClientView(username, ip_addr, port_no);
			view.setTitle("Battle Ground Picking");
			setVisible(false);
		}
	}
}
